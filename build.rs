...
fn main(){
    for shader_name in &[
            "resources/shaders/solidcolor_polygon_3d",
            "resources/shaders/textured_polygon_2d",
            "resources/shaders/untextured_polygon_2d",
            "resources/shaders/textured_polygon_3d"
        ]{
